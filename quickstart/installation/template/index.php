...
<html lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>">
	...
	<body data-basepath="<?php echo JUri::root(true); ?>">
		...
		<div class="container">
         ...
         .btn-primary, .step.active span { background: #007bff;border-color: transparent; }
			.btn-primary:hover ,.btn-primary:focus { background: #007bff;}
         .nav-tabs>.active>a, .nav-tabs>.active>a:hover, .nav-tabs>.active>a:focus {color: #007bff;}
